...
import data from "../src/data/transport.json" with { type: "json" };
...
await client.createOrReplace({
  ...
  serviceBody: data.serviceBody,
  additionalHeading: data.additionalHeading,
  additionalIntro: data.additionalIntro,
  additionalServices: withKeys(data.additionalServices, "transport-service"),
...
console.log("Seeded Sanity document: transportPage.main");
