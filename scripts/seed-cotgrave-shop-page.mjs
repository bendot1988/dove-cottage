...
const cotgravePath = path.join(root, "src/content/shops/cotgrave.md");
const file = readFileSync(cotgravePath, "utf8");
...
await client.createOrReplace({
  _id: "cotgraveShopPage.main",
  _type: "cotgraveShopPage",
  title: data.title,
...
console.log("Seeded Sanity document: cotgraveShopPage.main");
