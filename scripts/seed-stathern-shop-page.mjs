...
const sourcePath = path.join(root, "src/content/shops/stathern.md");
...
await client.createOrReplace({
  _id: "stathernShopPage.main",
  _type: "stathernShopPage",
  title: data.title,
...
console.log("Seeded Sanity document: stathernShopPage.main");
