...
import data from "../src/data/nursing-care-medical-advice.json" with { type: "json" };
...
await client.createOrReplace({
  ...
  nursingHeading: data.nursingHeading,
  nursingIntro: data.nursingIntro,
  nursingList: withKeys(data.nursingList, "nursing"),
  medicalHeading: data.medicalHeading,
  medicalBody: data.medicalBody,
  advocacyHeading: data.advocacyHeading,
  advocacyIntro: data.advocacyIntro,
  advocacyList: withKeys(data.advocacyList, "advocacy"),
  additionalHeading: data.additionalHeading,
  additionalIntro: data.additionalIntro,
  additionalServices: withKeys(data.additionalServices, "additional-service"),
...
console.log("Seeded Sanity document: nursingCareMedicalAdvicePage.main");
