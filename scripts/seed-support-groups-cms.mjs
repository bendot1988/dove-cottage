...
await client.createOrReplace({
  ...
  cards: [
    {
      _key: "support-card-0",
      title: supportGroups.cards?.[0]?.title ?? "Men's Shed",
      excerpt: supportGroups.cards?.[0]?.excerpt ?? "",
      image: asImageSource(mensShed.heroImage),
      imageAlt: supportGroups.cards?.[0]?.imageAlt ?? mensShed.heroImageAlt,
      badge: supportGroups.cards?.[0]?.badge ?? "Group support",
      stat: supportGroups.cards?.[0]?.stat ?? "",
      ctaLabel: supportGroups.cards?.[0]?.ctaLabel ?? "Find out more",
      href: supportGroups.cards?.[0]?.href ?? "/hospice-services/mens-shed/",
    },
    {
      _key: "support-card-1",
      title: supportGroups.cards?.[1]?.title ?? "Bereavement Support",
      excerpt: supportGroups.cards?.[1]?.excerpt ?? "",
      image: asImageSource(bereavementSupportGroup.heroImage),
      imageAlt: supportGroups.cards?.[1]?.imageAlt ?? bereavementSupportGroup.heroImageAlt,
      badge: supportGroups.cards?.[1]?.badge ?? "Drop-in support",
      stat: supportGroups.cards?.[1]?.stat ?? "",
      ctaLabel: supportGroups.cards?.[1]?.ctaLabel ?? "Find out more",
      href: supportGroups.cards?.[1]?.href ?? "/hospice-services/bereavement-support-group/",
    },
    {
      _key: "support-card-2",
      title: supportGroups.cards?.[2]?.title ?? "Carer Support",
      excerpt: supportGroups.cards?.[2]?.excerpt ?? "",
      image: asImageSource(carerSupportGroup.heroImage),
      imageAlt: supportGroups.cards?.[2]?.imageAlt ?? carerSupportGroup.heroImageAlt,
      badge: supportGroups.cards?.[2]?.badge ?? "Carer support",
      stat: supportGroups.cards?.[2]?.stat ?? "",
      ctaLabel: supportGroups.cards?.[2]?.ctaLabel ?? "Find out more",
      href: supportGroups.cards?.[2]?.href ?? "/hospice-services/carer-support/",
    },
  ],
