...
import data from "../src/data/complementary-therapies.json" with { type: "json" };
...
await client.createOrReplace({
  ...
  benefitsList: withKeys(data.benefitsList, "benefit"),
  treatmentsHeading: data.treatmentsHeading,
  treatmentsIntro: data.treatmentsIntro,
  treatmentsList: withKeys(data.treatmentsList, "treatment"),
...
console.log("Seeded Sanity document: complementaryTherapiesPage.main");
