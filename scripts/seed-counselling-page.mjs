...
import data from "../src/data/counselling.json" with { type: "json" };
...
await client.createOrReplace({
  ...
  emotionalHeading: data.emotionalHeading,
  emotionalIntro: data.emotionalIntro,
  emotionalList: withKeys(data.emotionalList, "emotional"),
  practicalHeading: data.practicalHeading,
  practicalBody: data.practicalBody,
...
console.log("Seeded Sanity document: counsellingPage.main");
