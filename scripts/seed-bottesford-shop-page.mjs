...
const sourcePath = path.join(root, "src/content/shops/bottesford.md");
...
await client.createOrReplace({
  _id: "bottesfordShopPage.main",
  _type: "bottesfordShopPage",
  title: data.title,
...
console.log("Seeded Sanity document: bottesfordShopPage.main");
