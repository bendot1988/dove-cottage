...
import data from "../src/data/spiritual-chaplaincy-support.json" with { type: "json" };
...
await client.createOrReplace({
  _id: "spiritualChaplaincySupportPage.main",
  _type: "spiritualChaplaincySupportPage",
  ...
  supportList: withKeys(data.supportList, "support-item"),
...
console.log("Seeded Sanity document: spiritualChaplaincySupportPage.main");
